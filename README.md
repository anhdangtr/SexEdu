...
- The rate of first sexual intercourse before age 14 doubled between 2013–2019  

Source: [link](https://www.qdnd.vn/cung-ban-luan/lo-hong-giao-duc-gioi-tinh-698160)
...
Source: [link](https://www.thetrumpet.com/1118-failing-sex-education)

---

## Our Insight

> The problem is not just a lack of information —  
> but a lack of **safe and private access** to that information.
...
- A unique **disguise mode**, allowing users to switch into a normal chatbot via:
  - Double-click logo  
  - `Ctrl + Shift + H`  
  - Automatic switching after 30 seconds of inactivity  
...
- Easily influenced by misinformation  

### Late Teens (16–19) — Main Target
- More exposure to relationships  
- Actively search online for answers  
- Still feel embarrassed asking adults  

### Core Focus
**Ages 15–18** — highest need and most active digital users
...
- **Education Mode** — Sexual education guidance  
- **Disguise Mode** — General academic assistant  
...
### 1. AI Safety  
Balancing helpful and safe responses  

### 2. Disguise Mode UX  
Ensuring realistic and seamless switching  

### 3. Time Constraint  
Delivering a meaningful product within 36 hours  
...
- Localization for Vietnam and Asia  
- Partnerships with schools and NGOs  
- Improved safety and expert-reviewed content  
...
- Reduced hesitation in asking questions  
